...
<head>
    ...
    <title>Login - PHP Intern Test</title>
        ...
        <div class="border border-success mt-4 px-5 py-3">
            <div class="nav-header">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <a href="login.php"><div class="btn btn-primary px-3">Login</div></a>
                    </div>
            ...
            <div class="content border border-secondary my-4 mx-5">
                <form method="POST" action="" class="m-4">
                    ...
                    <p class="mt-3 text-14">Not a member ? <a class="text-decoration-none" href="register.php">Signup now</a></p>
                </form>
            </div>
